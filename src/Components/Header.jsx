...
import resume from "../assets/resume/Rupon Mia (2).pdf";
const Header = () => {
      ...
      <AnimatePresence>
        {clicked && (
          <motion.div
            ...
            className="absolute left-0 top-16 w-full bg-gray-900/70 shadow-md md:hidden flex flex-col items-center gap-4 p-4 z-50">
